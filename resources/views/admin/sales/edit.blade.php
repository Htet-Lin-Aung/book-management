    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">{{ trans('cruds.sale.title_singular') }} {{ trans('global.update') }}</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="book_id" id="book_id" class="form-control {{ $errors->has('book_id') ? 'is-invalid' : '' }}" >
                                    ...
                                    @foreach ($books as $book)
                                        <option value="{{ $book->id }}"{{ $book->id == $sale->book_id ? 'selected' : '' }} price="{{ $book->price }}">{{ $book->name }} ({{ $book->price }} MMK)</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" id="quantity" value="{{ $sale->quantity }}" class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount" id="discount" value="{{ $sale->discount }}" class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="total" value="{{ $sale->total }}" id="total" placeholder="price * quantity" class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" >
                                @if($errors->has('total'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('total') }}
                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="paid" id="paid" value="{{ $sale->paid }}" class="form-control {{ $errors->has('paid') ? 'is-invalid' : '' }}" >
                                @if($errors->has('paid'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('paid') }}
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#quantity').on('input', function() {
            var price = document.getElementById('price').value;
            var quantity = document.getElementById('quantity').value;
            $('#total').attr("value",price * quantity);
        });

        $('#discount').on('input', function() {
            var discount = document.getElementById('discount').value;
            var total = document.getElementById('total').value;
            $('#paid').attr("value",total - discount);
        });
